locals {
  karpenter_node_role_name               = data.terraform_remote_state.eks_cluster.outputs.karpenter_node_role_name
  eks_cluster_node_group_name            = data.terraform_remote_state.eks_cluster.outputs.eks_cluster_node_group_name
  eks_cluster_certificate_authority_data = data.terraform_remote_state.eks_cluster.outputs.eks_cluster_certificate_authority_data
